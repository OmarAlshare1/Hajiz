...
(0, validateEnvironment_1.validateEnvironmentMiddleware)();
...
app.use(validateEnvironment_1.additionalSecurityHeaders);
app.use(validateEnvironment_1.securityLogger);
app.use(security_2.bruteForceProtection);
app.use(security_2.botDetection);
app.use(security_2.apiEndpointProtection);
app.use(security_2.trackFailedAuth);
...
const security_3 = __importDefault(require("./routes/security"));
app.use('/api/security', security_3.default);
app.get('/', (_req, res) => {
